! function (t, e) {
  ...
  var a = {
      getProvinceNameByCityName: function (t) {
        for (var e = i.provinces, n = 0; n < e.length; n++)
          for (var o = e[n].n, a = e[n].cities, r = 0; r < a.length; r++)
            if (a[r].n == t) return o;
        return null
      },
      getCenterByCityName: function (t) {
        t = t.replace("市", "");
        for (var e = 0; e < i.municipalities.length; e++)
          if (i.municipalities[e].n == t) return o(i.municipalities[e].g);
        for (e = 0; e < i.other.length; e++)
          if (i.other[e].n == t) return o(i.other[e].g);
        var n = i.provinces;
        for (e = 0; e < n.length; e++) {
          if (n[e].n == t) return o(n[e].g);
          for (var a = n[e].cities, r = 0; r < a.length; r++)
            if (a[r].n == t) return o(a[r].g)
        }
        return null
      }
    },
  ...
  g.prototype = n.prototype, g.prototype.add = function (t, e) {
    if (Array.isArray(t))
    ...
    this._data = []
  }, g.prototype.remove = function (t) {}, g.prototype.update = function (t, e) {
  ...
  }, g.prototype.transferCoordinate = function (t, e, n, i) {
    ...
    for (var o = 0; o < t.length; o++) {
      ...
      switch (a.type) {
        case "Point":
          ...
          break;
        case "LineString":
          for (var s = [], l = 0; l < r.length; l++) s.push(e(r[l]));
          a[i] = s;
          break;
        case "Polygon":
          s = g(r);
    ...
    return t
  }, g.prototype.initGeometry = function (t) {
  ...
  }, g.prototype.getUnique = function (t) {
  ...
  var c = {
      drawDataSet: function (t, e, n) {
        for (var i = e instanceof g ? e.get() : e, o = 0, a = i.length; o < a; o++) {
          var r = i[o];
          this.draw(t, r, n)
        }
      },
            ...
            "circle" === a ? ("Point" === n.bigData && t.moveTo(o[0], o[1]), t.arc(o[0], o[1], r, 0, 2 * Math.PI)) : "rect" === a ? t.rect(o[0] - r / 2, o[1] - r / 2, r, r) : "honeycomb" === a && function (t, e, n, i) {
              for (var o = 0; o < 6; o++) {
                var a = (r = {
                  x: e,
                  y: n
                }, s = i, l = 60 * o + 30, h = Math.PI / 180 * l, [r.x + s * Math.cos(h), r.y + s * Math.sin(h)]);
                t.lineTo(a[0], a[1])
              }
              var r, s, l, h
            }(t, o[0], o[1], r);
      ...
      draw: function (t, e, n) {
        ...
        if (n.bigData) {
          ...
          for (a = 0, r = i.length; a < r; a++) {
            ...
            t.beginPath(), c.draw(t, s, n), "Point" == l || "Polygon" == l || "MultiPolygon" == l ? (t.fill(), (s.strokeStyle || n.strokeStyle) && n.lineWidth && t.stroke()) : "LineString" == l && ((s.lineWidth || s._lineWidth) && (t.lineWidth = s.lineWidth || s._lineWidth), t.stroke()), t.restore()
          }
        t.restore()
      }
    };
  ...
  v.prototype.setMax = function (t) {
    this.max = t || 100
  }, v.prototype.setMin = function (t) {
    this.min = t || 0
  }, v.prototype.setMaxSize = function (t) {
    this.maxSize = t || 35
  }, v.prototype.setMinSize = function (t) {
    this.minSize = t || 0
  }, v.prototype.initPalette = function () {
    var t = this.gradient,
      e = new f(256, 1),
  ...
  }, v.prototype.getColor = function (t) {
    var e = this.getImageData(t);
    return "rgba(" + e[0] + ", " + e[1] + ", " + e[2] + ", " + e[3] / 256 + ")"
  }, v.prototype.getImageData = function (t) {
  ...
  }, v.prototype.getSize = function (t) {
    var e = this.max,
      n = this.min,
      i = this.maxSize,
      o = this.minSize;
    return t > e && (t = e), t < n && (t = n), o + (t - n) / (e - n) * (i - o)
  }, v.prototype.getLegend = function (t) {
    var e = this.gradient,
      n = t.width || 20,
      i = t.height || 180,
      o = new f(n, i),
  ...
  function y(t, e, n) {
    ...
    var r, s, l, h, u, g = new v({
        gradient: n.gradient,
        max: i,
        min: o
      }),
      p = (h = new f(2 * (l = (r = a) + (s = r / 2)), 2 * l), (u = h.getContext("2d")).shadowBlur = s, u.shadowColor = "black", u.shadowOffsetX = u.shadowOffsetY = 1e4, u.beginPath(), u.arc(l - 1e4, l - 1e4, r, 0, 2 * Math.PI, !0), u.closePath(), u.fill(), h),
      d = p.width / 2,
      y = p.height / 2,
      m = {};
    e.forEach(function (t, e) {
      var n = void 0 === t.count ? 1 : t.count,
        o = Math.min(1, n / i).toFixed(2);
      m[o] = m[o] || [], m[o].push(t)
    });
    for (var x in m)
      if (!isNaN(x)) {
        var _ = m[x];
        t.beginPath(), n.withoutAlpha || (t.globalAlpha = x), t.strokeStyle = g.getColor(x * i), _.forEach(function (e, o) {
          if (e.geometry) {
            var a = e.geometry._coordinates || e.geometry.coordinates,
              r = e.geometry.type;
            if ("Point" === r) {
              var s = void 0 === e.count ? 1 : e.count;
              t.globalAlpha = s / i, t.drawImage(p, a[0] - d, a[1] - y)
            } else if ("LineString" === r) {
              s = void 0 === e.count ? 1 : e.count;
              t.globalAlpha = s / i, t.beginPath(), c.draw(t, e, n), t.stroke()
            }
          }
        })
      }
  ...
  var m = {
      draw: function (t, e, n) {
        if (!(t.canvas.width <= 0 || t.canvas.height <= 0)) {
          ...
          var o = new f(t.canvas.width, t.canvas.height),
            a = o.getContext("2d");
          a.scale(d, d), n = n || {};
          var r = e instanceof g ? e.get() : e;
          t.save();
          var s = new v({
            gradient: n.gradient
          });
          if (y(a, r, n), !n.absolute) {
            var l = a.getImageData(0, 0, t.canvas.width, t.canvas.height);
            ! function (t, e, n) {
              for (var i, o = n.maxOpacity || .8, a = 3, r = t.length; a < r; a += 4) i = 4 * t[a], t[a] / 256 > o && (t[a] = 256 * o), t[a - 3] = e[i], t[a - 2] = e[i + 1], t[a - 1] = e[i + 2]
    ...
    x = {
      draw: function (t, e, n) {
        t.save();
        for (var i = e instanceof g ? e.get() : e, o = {}, a = n._size || n.size || 50, r = n.offset || {
            x: 0,
            y: 0
          }, s = 0; s < i.length; s++) {
          var l = i[s].geometry._coordinates || i[s].geometry.coordinates;
          o[u = Math.floor((l[0] - r.x) / a) + "," + Math.floor((l[1] - r.y) / a)] || (o[u] = 0), o[u] += ~~(i[s].count || 1)
        }
        var h = new v({
          max: n.max || 100,
          gradient: n.gradient
        });
        for (var u in o) u = u.split(","), t.beginPath(), t.rect(u[0] * a + .5 + r.x, u[1] * a + .5 + r.y, a, a), t.fillStyle = h.getColor(o[u]), t.fill(), n.strokeStyle && n.lineWidth && t.stroke();
        if (n.label && !1 !== n.label.show) {
          ...
          for (var u in o) {
            ...
            t.fillText(c, u[0] * a + .5 + r.x + a / 2 - p / 2, u[1] * a + .5 + r.y + a / 2 + 5)
          }
        }
        t.restore()
      }
  ...
  var _ = {
    draw: function (t, e, n) {
      ...
      for (var a = n.offset || {
          x: 10,
          y: 10
        }, r = n._size || n.size || 40, s = 2 * (r = r / 2 / Math.sin(Math.PI / 3)) * Math.sin(Math.PI / 3), l = 1.5 * r, h = {}, u = 0; u < i.length; u++) {
        ...
        if (3 * Math.abs(m) > 1) {
          var x = d - y,
            ...
            b = d - _,
            S = p - w;
          x * x + m * m > b * b + S * S && (y = _ + (1 & f ? 1 : -1) / 2, f = w)
        }
        var M = y + "-" + f,
          C = h[M];
        C ? C.push(i[u]) : ((C = h[M] = [i[u]]).i = y, C.j = f, C.x = (y + (1 & f ? .5 : 0)) * s, C.y = f * l)
      }
      var A, L, P, k, E = new v({
        max: n.max || 100,
        maxSize: r,
      ...
      for (var o in h) {
        ...
        for (var F = 0; F < 6; F++) {
          var R = (A = {
            x: z.x + a.x,
            y: z.y + a.y
          }, L = r, void 0, void 0, P = 60 * F + 30, k = Math.PI / 180 * P, [A.x + L * Math.cos(k), A.y + L * Math.sin(k)]);
          t.lineTo(R[0], R[1])
        }
        t.closePath();
        var I = 0;
        for (u = 0; u < z.length; u++) I += z[u].count || 1;
        z.count = I, t.fillStyle = E.getColor(I), t.fill(), n.strokeStyle && n.lineWidth && t.stroke()
      }
      if (n.label && !1 !== n.label.show) {
        t.fillStyle = n.label.fillStyle || "white", n.label.font && (t.font = n.label.font), n.label.shadowColor && (t.shadowColor = n.label.shadowColor), n.label.shadowBlur && (t.shadowBlur = n.label.shadowBlur);
        for (var o in h) {
          var T = (z = h[o]).count;
          T = T < 0 ? T.toFixed(2) : ~~T;
          var O = t.measureText(T).width;
          t.fillText(T, z.x + a.x - O / 2, z.y + a.y + 5)
        }
      }
      t.restore()
    }
  ...
  function b(t, e, n) {
    var i = w(t, e, t.VERTEX_SHADER),
      o = w(t, n, t.FRAGMENT_SHADER),
      a = t.createProgram();
  ...
  var A = {
      draw: function (t, e, n) {
        if (e) {
          ...
          var l = t.getUniformLocation(i, "u_FragColor"),
            h = S(n.strokeStyle || "red");
          t.uniform4f(l, h[0] / 255, h[1] / 255, h[2] / 255, h[3] / 255), t.lineWidth(n.lineWidth || 1);
          for (var u = 0, g = e.length; u < g; u++) {
            for (var c = e[u].geometry._coordinates, p = [], f = 0; f < c.length; f++) {
              var v = c[f],
                d = (v[0] - o) / o,
                y = (a - v[1]) / a;
              p.push(d, y)
            ...
            t.bufferData(t.ARRAY_BUFFER, m, t.STATIC_DRAW), t.drawArrays(t.LINE_STRIP, 0, c.length)
          }
        }
      }
    },
    L = ["attribute vec4 a_Position;", "attribute float a_PointSize;", "void main() {", "gl_Position = a_Position;", "gl_PointSize = a_PointSize;", "}"].join(""),
  ...
  var E = {
    draw: function (t, e, n) {
      if (e) {
        ...
        for (var s = t.canvas.width / 2, l = t.canvas.height / 2, h = [], u = 0, g = 0; g < e.length; g++) {
          var c = e[g].geometry._coordinates,
            p = (c[0] - s) / s,
            f = (l - c[1]) / l;
          p < -1 || p > 1 || f < -1 || f > 1 || (h.push(p, f), u++)
        }
        var v = new Float32Array(h),
          d = u,
          y = t.createBuffer();
        t.bindBuffer(t.ARRAY_BUFFER, y), t.bufferData(t.ARRAY_BUFFER, v, t.STATIC_DRAW), t.vertexAttribPointer(o, 2, t.FLOAT, !1, 0, 0), t.enableVertexAttribArray(o), t.vertexAttrib1f(a, n._size);
        var m = S(n.fillStyle || "red");
        t.uniform4f(r, m[0] / 255, m[1] / 255, m[2] / 255, m[3] / 255), t.drawArrays(t.POINTS, 0, d)
      }
    }
  };
  ...
  function z(t, e, n) {
    n = n || 2;
    var i, o, a, r, s, l, h, u = e && e.length,
      g = u ? e[0] * n : t.length,
      c = F(t, 0, g, n, !0),
      p = [];
    if (!c) return p;
    if (u && (c = function (t, e, n, i) {
        var o, a, r, s, l, h = [];
        for (o = 0, a = e.length; o < a; o++) r = e[o] * i, s = o < a - 1 ? e[o + 1] * i : t.length, (l = F(t, r, s, i, !1)) === l.next && (l.steiner = !0), h.push(j(l));
        for (h.sort(N), o = 0; o < h.length; o++) U(h[o], n), n = R(n, n.next);
        return n
      }(t, e, c, n)), t.length > 80 * n) {
      i = a = t[0], o = r = t[1];
      for (var f = n; f < g; f += n) s = t[f], l = t[f + 1], s < i && (i = s), l < o && (o = l), s > a && (a = s), l > r && (r = l);
      h = Math.max(a - i, r - o)
    }
    return I(c, p, n, i, o, h), p
  }

  function F(t, e, n, i, o) {
    var a, r;
    if (o === K(t, e, n, i) > 0)
      for (a = e; a < n; a += i) r = V(a, t[a], t[a + 1], r);
    else
      for (a = n - i; a >= e; a -= i) r = V(a, t[a], t[a + 1], r);
    return r && q(r, r.next) && (Q(r), r = r.next), r
  }
  ...
  function R(t, e) {
    ...
    var n, i = t;
    do {
      if (n = !1, i.steiner || !q(i, i.next) && 0 !== H(i.prev, i, i.next)) i = i.next;
      else {
        if (Q(i), (i = e = i.prev) === i.next) return null;
        n = !0
      }
    } while (n || i !== e);
    return e
  ...
  function I(t, e, n, i, o, a, r) {
    if (t) {
      !r && a && function (t, e, n, i) {
        var o = t;
        do {
          null === o.z && (o.z = Z(o.x, o.y, e, n, i)), o.prevZ = o.prev, o.nextZ = o.next, o = o.next
        } while (o !== t);
        o.prevZ.nextZ = null, o.prevZ = null,
          function (t) {
            var e, n, i, o, a, r, s, l, h = 1;
            do {
              for (n = t, t = null, a = null, r = 0; n;) {
                for (r++, i = n, s = 0, e = 0; e < h && (s++, i = i.nextZ); e++);
                for (l = h; s > 0 || l > 0 && i;) 0 === s ? (o = i, i = i.nextZ, l--) : 0 !== l && i ? n.z <= i.z ? (o = n, n = n.nextZ, s--) : (o = i, i = i.nextZ, l--) : (o = n, n = n.nextZ, s--), a ? a.nextZ = o : t = o, o.prevZ = a, a = o;
                n = i
              }
              a.nextZ = null, h *= 2
            } while (r > 1)
      ...
      for (var s, l, h = t; t.prev !== t.next;)
        if (s = t.prev, l = t.next, a ? O(t, i, o, a) : T(t)) e.push(s.i / n), e.push(t.i / n), e.push(l.i / n), Q(t), t = l.next, h = l.next;
        else if ((t = l) === h) {
        r ? 1 === r ? I(t = B(t, e, n), e, n, i, o, a, 2) : 2 === r && D(t, e, n, i, o, a) : I(R(t), e, n, i, o, a, 1);
        break
      }
    }
  }
  ...
  function T(t) {
    var e = t.prev,
      n = t,
      i = t.next;
    if (H(e, n, i) >= 0) return !1;
    for (var o = t.next.next; o !== t.prev;) {
      if (W(e.x, e.y, n.x, n.y, i.x, i.y, o.x, o.y) && H(o.prev, o, o.next) >= 0) return !1;
      o = o.next
    }
    return !0
  }
  ...
  function O(t, e, n, i) {
    var o = t.prev,
      a = t,
      r = t.next;
    if (H(o, a, r) >= 0) return !1;
    for (var s = o.x < a.x ? o.x < r.x ? o.x : r.x : a.x < r.x ? a.x : r.x, l = o.y < a.y ? o.y < r.y ? o.y : r.y : a.y < r.y ? a.y : r.y, h = o.x > a.x ? o.x > r.x ? o.x : r.x : a.x > r.x ? a.x : r.x, u = o.y > a.y ? o.y > r.y ? o.y : r.y : a.y > r.y ? a.y : r.y, g = Z(s, l, e, n, i), c = Z(h, u, e, n, i), p = t.nextZ; p && p.z <= c;) {
      if (p !== t.prev && p !== t.next && W(o.x, o.y, a.x, a.y, r.x, r.y, p.x, p.y) && H(p.prev, p, p.next) >= 0) return !1;
      p = p.nextZ
    }
  ...
  function B(t, e, n) {
    ...
    do {
      var o = i.prev,
        a = i.next.next;
      !q(o, a) && Y(o, i, i.next, a) && G(o, a) && G(a, o) && (e.push(o.i / n), e.push(i.i / n), e.push(a.i / n), Q(i), Q(i.next), i = t = a), i = i.next
    } while (i !== t);
    return i
  }

  function D(t, e, n, i, o, a) {
    var r, s, l = t;
    do {
      for (var h = l.next.next; h !== l.prev;) {
        if (l.i !== h.i && (s = h, (r = l).next.i !== s.i && r.prev.i !== s.i && ! function (t, e) {
            var n = t;
            do {
          ...
          var u = J(l, h);
          return l = R(l, l.next), u = R(u, u.next), I(l, e, n, i, o, a), void I(u, e, n, i, o, a)
        }
        h = h.next
      }
      l = l.next
  ...
  function U(t, e) {
    if (e = function (t, e) {
        ...
        var l, h = n,
          ...
          c = 1 / 0;
        i = n.next;
        for (; i !== h;) o >= i.x && i.x >= u && W(a < g ? o : r, a, u, g, a < g ? r : o, a, i.x, i.y) && ((l = Math.abs(a - i.y) / (o - i.x)) < c || l === c && i.x > n.x) && G(i, t) && (n = i, c = l), i = i.next;
        return n
      }(t, e)) {
      var n = J(e, t);
      R(n, n.next)
  ...
  function Y(t, e, n, i) {
    return !!(q(t, e) && q(n, i) || q(t, i) && q(n, e)) || H(t, e, n) > 0 != H(t, e, i) > 0 && H(n, i, t) > 0 != H(n, i, e) > 0
  }

  function G(t, e) {
    return H(t.prev, t, t.next) < 0 ? H(t, e, t.next) >= 0 && H(t, t.prev, e) >= 0 : H(t, e, t.prev) < 0 || H(t, t.next, e) < 0
  }

  function J(t, e) {
    var n = new X(t.i, t.x, t.y),
      i = new X(e.i, e.x, e.y),
      o = t.next,
      a = e.prev;
  ...
  z.deviation = function (t, e, n, i) {
    var o = e && e.length,
      a = o ? e[0] * n : t.length,
      r = Math.abs(K(t, 0, a, n));
    if (o)
      for (var s = 0, l = e.length; s < l; s++) {
        var h = e[s] * n,
          u = s < l - 1 ? e[s + 1] * n : t.length;
        r -= Math.abs(K(t, h, u, n))
      }
    var g = 0;
    for (s = 0; s < i.length; s += 3) {
      var c = i[s] * n,
        p = i[s + 1] * n,
        f = i[s + 2] * n;
      g += Math.abs((t[c] - t[f]) * (t[p + 1] - t[c + 1]) - (t[c] - t[p]) * (t[f + 1] - t[c + 1]))
    }
    return 0 === r && 0 === g ? 0 : Math.abs((g - r) / r)
  ...
  var $ = ["attribute vec4 a_Position;", "void main() {", "gl_Position = a_Position;", "gl_PointSize = 30.0;", "}"].join(""),
    tt = ["precision mediump float;", "uniform vec4 u_FragColor;", "void main() {", "gl_FragColor = u_FragColor;", "}"].join("");
  var et = {
      draw: function (t, e, n) {
        if (e) {
          ...
          for (var h = [], u = [], g = 0, c = 0, p = e.length; c < p; c++) {
            var f = z.flatten(e[c].geometry._coordinates || e[c].geometry.coordinates),
              v = f.vertices;
            g = h.length / 2;
            for (var d = 0; d < v.length; d += 2) v[d] = (v[d] - o) / o, v[d + 1] = (a - v[d + 1]) / a;
            for ((h.length + v.length) / 2 > 65536 && (t.bufferData(t.ARRAY_BUFFER, new Float32Array(h), t.STATIC_DRAW), t.bufferData(t.ELEMENT_ARRAY_BUFFER, new Uint16Array(u), t.STATIC_DRAW), t.drawElements(t.TRIANGLES, u.length, t.UNSIGNED_SHORT, 0), h.length = 0, u.length = 0, g = 0), d = 0; d < v.length; d++) h.push(v[d]);
            var y = z(v, f.holes, f.dimensions);
            for (d = 0; d < y.length; d++) u.push(y[d] + g)
          }
          t.bufferData(t.ARRAY_BUFFER, new Float32Array(h), t.STATIC_DRAW), t.bufferData(t.ELEMENT_ARRAY_BUFFER, new Uint16Array(u), t.STATIC_DRAW), t.drawElements(t.TRIANGLES, u.length, t.UNSIGNED_SHORT, 0), t.bindBuffer(t.ARRAY_BUFFER, null), t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, null)
        }
      }
    },
    nt = {
      draw: function (t, e, n) {
        var i = e instanceof g ? e.get() : e;
        i.length > 0 && ("LineString" == i[0].geometry.type ? A.draw(t, i, n) : "Polygon" == i[0].geometry.type || "MultiPolygon" == i[0].geometry.type ? et.draw(t, i, n) : E.draw(t, i, n))
      }
    };

  function it(t, e, n) {
    if (!t || !e) return null;
    var i, o, a, r, s, l, h = function (t) {
        return 1 - 2 * t + t * t
      },
      u = function (t) {
        return 2 * t - 2 * t * t
      ...
      f = 0;
    if (void 0 !== e) {
      var v = parseFloat(t.lat),
        d = parseFloat(e.lat),
        y = parseFloat(t.lng),
        m = parseFloat(e.lng);
      for (m > y && parseFloat(m - y) > 180 && y < 0 && (y = parseFloat(360 + y)), y > m && parseFloat(y - m) > 180 && m < 0 && (m = parseFloat(360 + m)), 0, l = 0, d == v ? (i = 0, o = y - m) : m == y ? (i = Math.PI / 2, o = v - d) : (i = Math.atan((d - v) / (m - y)), o = (d - v) / Math.sin(i)), 0 == l && (l = i + Math.PI / 5), s = (a = o / 2) * Math.cos(l) + y, r = a * Math.sin(l) + v, p = 0; p < n + 1; p++) c.push([y * h(f) + s * u(f) + m * g(f), v * h(f) + r * u(f) + d * g(f)]), f += 1 / n;
      return c
    }
    void 0 !== c && (c = [])
  }
  ...
  at.prototype.get = function (t) {
    ...
    return n
  }, at.prototype.generateByDataSet = function (t, e) {
  ...
  }, at.prototype.getLegend = function (t) {
    var e = this.splitList,
    ...
    return n
  }, rt.prototype.generateByDataSet = function (t) {
    var e = t.getMin("count"),
      n = t.getMax("count");
    this.generateByMinMax(e, n)
  }, rt.prototype.generateByMinMax = function (t, e) {
  ...
  }, rt.prototype.getLegend = function (t) {
    this.splitList
  };
  var st = function () {
    function t(e, n, i) {
      ...
      this.type = n;
      var o = i && i.center ? i.center : [106.962497, 38.208726],
        a = i && i.zoom ? i.zoom : 5,
        s = this.map = new BMap.Map(e, {
          enableMapClick: !1
        });
      s.centerAndZoom(new BMap.Point(o[0], o[1]), a), s.enableScrollWheelZoom(!0), s.setMapStyle({
        style: "light"
      })
    }
    return s(t, [{
  ...
  var ht = "undefined" == typeof window ? {} : window;
  ht.BMap && (lt.prototype = new BMap.Overlay, lt.prototype.initialize = function (t) {
    this._map = t;
  ...
  }, lt.prototype.adjustSize = function () {
    var t = this._map.getSize(),
      e = this.canvas,
      n = this.devicePixelRatio = ht.devicePixelRatio || 1;
  ...
  }, lt.prototype.getContainer = function () {
    return this.canvas
  ...
  }, lt.prototype.setZIndex = function (t) {
    this.zIndex = t, this.canvas.style.zIndex = this.zIndex
  }, lt.prototype.getZIndex = function () {
    return this.zIndex
  });
  var ut, gt, ct = ct || (ut = [], {
    getAll: function () {
    ...
    remove: function (t) {
      var e = ut.indexOf(t); - 1 !== e && ut.splice(e, 1)
    },
    update: function (t, e) {
      if (0 === ut.length) return !1;
      var n = 0;
      for (t = void 0 !== t ? t : ct.now(); n < ut.length;) ut[n].update(t) || e ? n++ : ut.splice(n, 1);
      return !0
    }
  });
  "undefined" == typeof window && "undefined" != typeof process ? ct.now = function () {
    var t = process.hrtime();
    return 1e3 * t[0] + t[1] / 1e6
  } : "undefined" != typeof window && void 0 !== window.performance && void 0 !== window.performance.now ? ct.now = window.performance.now.bind(window.performance) : void 0 !== Date.now ? ct.now = Date.now : ct.now = function () {
    ...
    var e, n = t,
      ...
      g = 0,
      c = null,
      p = ct.Easing.Linear.None,
      f = ct.Interpolation.Linear,
      v = [],
      d = null,
      y = !1,
      m = null,
    ...
    this.to = function (t, e) {
      ...
      ct.add(this), h = !0, y = !1, c = void 0 !== t ? t : ct.now(), c += g;
      for (var e in o) {
      ...
      return h ? (ct.remove(this), h = !1, null !== _ && _.call(n, n), this.stopChainedTweens(), this) : this
    }, this.end = function () {
      return this.update(c + r), this
      ...
      var h, _, w;
      if (t < c) return !0;
      !1 === y && (null !== d && d.call(n, n), y = !0), w = p(_ = (_ = (t - c) / r) > 1 ? 1 : _);
      for (h in o)
        if (void 0 !== i[h]) {
          var b = i[h] || 0,
            S = o[h];
          S instanceof Array ? n[h] = f(S, w) : ("string" == typeof S && (S = "+" === S.charAt(0) || "-" === S.charAt(0) ? b + parseFloat(S) : parseFloat(S)), "number" == typeof S && (n[h] = b + (S - b) * w))
        }
      if (null !== m && m.call(n, w), 1 === _) {
        if (s > 0) {
          isFinite(s) && s--;
          for (h in a) {
            if ("string" == typeof o[h] && (a[h] = a[h] + parseFloat(o[h])), l) {
              var M = a[h];
              a[h] = o[h], o[h] = M
            }
            i[h] = a[h]
          }
          return l && (u = !u), c = void 0 !== e ? t + e : t + g, !0
        }
        null !== x && x.call(n, n);
        for (var C = 0, A = v.length; C < A; C++) v[C].start(c + r);
        return !1
      }
      return !0
    }
    ...
    Bounce: {
      In: function (t) {
        return 1 - ct.Easing.Bounce.Out(1 - t)
      },
      Out: function (t) {
        return t < 1 / 2.75 ? 7.5625 * t * t : t < 2 / 2.75 ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : t < 2.5 / 2.75 ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375
      },
      InOut: function (t) {
        return t < .5 ? .5 * ct.Easing.Bounce.In(2 * t) : .5 * ct.Easing.Bounce.Out(2 * t - 1) + .5
      }
    }
  }, ct.Interpolation = {
    Linear: function (t, e) {
      var n = t.length - 1,
        i = n * e,
        o = Math.floor(i),
        a = ct.Interpolation.Utils.Linear;
      return e < 0 ? a(t[0], t[1], i) : e > 1 ? a(t[n], t[n - 1], n - i) : a(t[o], t[o + 1 > n ? n : o + 1], i - o)
    },
    Bezier: function (t, e) {
      for (var n = 0, i = t.length - 1, o = Math.pow, a = ct.Interpolation.Utils.Bernstein, r = 0; r <= i; r++) n += o(1 - e, i - r) * o(e, r) * t[r] * a(i, r);
      return n
    },
    CatmullRom: function (t, e) {
      var n = t.length - 1,
        i = n * e,
        o = Math.floor(i),
        a = ct.Interpolation.Utils.CatmullRom;
    ...
    Utils: {
      ...
      Bernstein: function (t, e) {
        var n = ct.Interpolation.Utils.Factorial;
        return n(t) / n(e) / n(t - e)
      },
      Factorial: (gt = [1], function (t) {
        var e = 1;
        if (gt[t]) return gt[t];
  ...
  var pt = function (t, e, n) {
    ...
    if (n.textAlign || (t.textAlign = "center"), n.textBaseline || (t.textBaseline = "middle"), n.avoid)
      for (var h = 0, u = i.length; h < u; h++) {
        var c = (x = i[h].geometry._coordinates || i[h].geometry.coordinates)[0] + a.x,
          p = x[1] + a.y,
          f = i[h][l],
          v = t.measureText(f).width,
          d = c - v / 2,
          y = p - s / 2,
          m = {
            sw: {
        ...
        ft(r, m) || (r.push(m), d += v / 2, y += s / 2, t.fillText(f, d, y))
      } else
        for (h = 0, u = i.length; h < u; h++) {
          var x;
          c = (x = i[h].geometry._coordinates || i[h].geometry.coordinates)[0] + a.x, p = x[1] + a.y, f = i[h][l];
          t.fillText(f, c, p)
        }
    t.restore()
  };
  ...
  var dt = function (t, e, n) {
    ...
    for (var o = n.offset || {
        x: 0,
        y: 0
      }, a = 0, r = i.length; a < r; a++)
      if (i[a].geometry) {
        var s = i[a].deg || n.deg,
          l = i[a].icon || n.icon,
          h = i[a].geometry._coordinates || i[a].geometry.coordinates,
          u = h[0],
          c = h[1];
        s && (t.save(), t.translate(u, c), t.rotate(s * Math.PI / 180), t.translate(-u, -c));
        var p = n._width || n.width || l.width,
          f = n._height || n.height || l.height;
        u = u - p / 2 + o.x, c = c - f / 2 + o.y, n.sx && n.sy && n.swidth && n.sheight && n.width && n.height ? t.drawImage(l, n.sx, n.sy, n.swidth, n.sheight, u, c, p, f) : n.width && n.height ? t.drawImage(l, u, c, p, f) : t.drawImage(l, u, c), s && t.restore()
      }
  };
  ...
  var yt = function () {
      function t(e, n, i) {
        r(this, t), n instanceof g || (n = new g(n)), this.dataSet = n, this.map = e
      }
      return s(t, [{
        ...
        value: function (t) {
          var e = this;
          if (e.intensity = new v({
              maxSize: e.options.maxSize,
              minSize: e.options.minSize,
              gradient: e.options.gradient,
              max: e.options.max || this.dataSet.getMax("count")
            }), e.category = new at(e.options.splitList), e.choropleth = new rt(e.options.splitList), void 0 === e.options.splitList && e.category.generateByDataSet(this.dataSet, e.options.color), void 0 === e.options.splitList) {
        ...
        value: function (t, n, i, o) {
          var a = this;
          switch (a.options.draw) {
            case "heatmap":
              m.draw(t, n, a.options);
              break;
            case "grid":
            case "honeycomb":
              a.options.offset = {
                x: o.x,
                y: o.y
              }, "grid" == a.options.draw ? x.draw(t, n, a.options) : _.draw(t, n, a.options);
              break;
            case "text":
              pt(t, n, a.options);
              break;
            case "icon":
              ...
              break;
            case "clip":
              t.save(), t.fillStyle = a.options.fillStyle || "rgba(0, 0, 0, 0.5)", t.fillRect(0, 0, t.canvas.width, t.canvas.height), p.draw(t, n, a.options), t.beginPath(), c.drawDataSet(t, n, a.options), t.clip(), e(t), t.restore();
              break;
            default:
              "webgl" == a.options.context ? nt.draw(a.canvasLayer.canvas.getContext("webgl"), n, a.options) : p.draw(t, n, a.options)
          }
        }
      }, {
        key: "isPointInPath",
        value: function (t, e) {
          ...
          for (var n = this.dataSet.get(), i = 0; i < n.length; i++) {
            t.beginPath(), c.draw(t, n[i], this.options);
            var o = e.x * this.canvasLayer.devicePixelRatio,
              a = e.y * this.canvasLayer.devicePixelRatio;
            if (t.isPointInPath(o, a) || t.isPointInStroke(o, a)) return n[i]
          }
        }
      }, {
        key: "clickEvent",
        ...
        value: function () {
          ...
          if ("time" == t.options.draw || t.isEnabledTime()) {
            ...
            }, t.animator = new ct.Tween(this.steps).onUpdate(function () {
        ...
        value: function () {
          ...
          if (e) {
            ...
            for (var n = this.options, i = 0; i < e.length; i++)
              ...
              var l = e[i].strokeStyle || n.strokeStyle,
                h = e[i].fillStyle || n.fillStyle || "yellow";
              t.fillStyle = h, t.fill(), l && n.lineWidth && (t.lineWidth = n.lineWidth || 1, t.strokeStyle = l, t.stroke())
            }
            t.restore()
          }
        }
    ...
    xt = function (t) {
      function n(t, e, i) {
        ...
        var o = u(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, t, e, i)),
          a = o;
        i = i || {}, o.clickEvent = o.clickEvent.bind(o), o.mousemoveEvent = o.mousemoveEvent.bind(o), a.init(i), a.argCheck(i), a.transferToMercator();
        var s = o.canvasLayer = new lt({
          map: t,
          context: o.context,
          paneName: i.paneName,
      ...
      return h(n, yt), s(n, [{
        ...
        value: function (t) {
          var e = t.pixel;
          l(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "clickEvent", this).call(this, e, t)
        }
      }, {
        key: "mousemoveEvent",
        value: function (t) {
          var e = t.pixel;
          l(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "mousemoveEvent", this).call(this, e, t)
        }
      }, {
        key: "bindEvent",
        value: function (t) {
        ...
        value: function (t) {
          if (this.canvasLayer) {
            var n = this,
              ...
              o = this.canvasLayer._map,
              a = Math.pow(2, 18 - o.getZoom()),
              r = o.getMapType().getProjection().lngLatToPoint(o.getCenter()),
              s = new BMap.Pixel(r.x - o.getSize().width / 2 * a, r.y + o.getSize().height / 2 * a),
              l = this.getContext();
            if (n.isEnabledTime()) {
              if (void 0 === t) return void e(l);
              "2d" == this.context && (l.save(), l.globalCompositeOperation = "destination-out", l.fillStyle = "rgba(0, 0, 0, .1)", l.fillRect(0, 0, l.canvas.width, l.canvas.height), l.restore())
            } else e(l);
            if ("2d" == this.context)
              for (var h in n.options) l[h] = n.options[h];
            else l.clear(l.COLOR_BUFFER_BIT);
            if (!(n.options.minZoom && o.getZoom() < n.options.minZoom || n.options.maxZoom && o.getZoom() > n.options.maxZoom)) {
              ...
              var c = n.dataSet.get(g);
              this.processData(c);
              var p = o.pointToPixel(new BMap.Point(0, 0));
              "m" == n.options.unit ? (n.options.size && (n.options._size = n.options.size / a), n.options.width && (n.options._width = n.options.width / a), n.options.height && (n.options._height = n.options.height / a)) : (n.options._size = n.options.size, n.options._height = n.options.height, n.options._width = n.options.width), this.drawContext(l, c, n.options, p), n.options.updateCallback && n.options.updateCallback(t)
            }
          }
        }
      }, {
  ...
  function _t(t) {
    this.isAdded_ = !1, this.isAnimated_ = !1, this.paneName_ = _t.DEFAULT_PANE_NAME_, this.updateHandler_ = null, this.resizeHandler_ = null, this.topLeft_ = null, this.centerListener_ = null, this.resizeListener_ = null, this.needsResize_ = !0, this.requestAnimationFrameId_ = null;
    var e = document.createElement("canvas");
  ...
  wt.google && wt.google.maps && (_t.prototype = new google.maps.OverlayView, _t.DEFAULT_PANE_NAME_ = "overlayLayer", _t.CSS_TRANSFORM_ = function () {
    ...
    return e[0]
  }(), _t.prototype.requestAnimFrame_ = wt.requestAnimationFrame || wt.webkitRequestAnimationFrame || wt.mozRequestAnimationFrame || wt.oRequestAnimationFrame || wt.msRequestAnimationFrame || function (t) {
    return wt.setTimeout(t, 1e3 / 60)
  }, _t.prototype.cancelAnimFrame_ = wt.cancelAnimationFrame || wt.webkitCancelAnimationFrame || wt.mozCancelAnimationFrame || wt.oCancelAnimationFrame || wt.msCancelAnimationFrame || function (t) {}, _t.prototype.setOptions = function (t) {
  ...
  }, _t.prototype.setAnimate = function (t) {
    this.isAnimated_ = !!t, this.isAnimated_ && this.scheduleUpdate()
  }, _t.prototype.isAnimated = function () {
    return this.isAnimated_
  }, _t.prototype.setPaneName = function (t) {
    this.paneName_ = t, this.setPane_()
  }, _t.prototype.getPaneName = function () {
    return this.paneName_
  }, _t.prototype.setPane_ = function () {
    if (this.isAdded_) {
      var t = this.getPanes();
      if (!t[this.paneName_]) throw new Error('"' + this.paneName_ + '" is not a valid MapPane name.');
      t[this.paneName_].appendChild(this.canvas)
    }
  }, _t.prototype.setResizeHandler = function (t) {
    this.resizeHandler_ = t
  }, _t.prototype.setResolutionScale = function (t) {
    "number" == typeof t && (this.resolutionScale_ = t, this.resize_())
  }, _t.prototype.setUpdateHandler = function (t) {
    this.updateHandler_ = t
  }, _t.prototype.onAdd = function () {
  ...
  }, _t.prototype.onRemove = function () {
  ...
  }, _t.prototype.repositionCanvas_ = function () {
    var t = this.getMap(),
    ...
    this.canvas.style[_t.CSS_TRANSFORM_] = "translate(" + r + "px," + s + "px)", this.scheduleUpdate()
  }, _t.prototype.update_ = function () {
  ...
  }, _t.prototype.getTopLeft = function () {
    return this.topLeft_
  }, _t.prototype.scheduleUpdate = function () {
      ...
      return h(n, yt), s(n, [{
        ...
        value: function (t) {
          if (this.canvasLayer) {
            ...
            if ("2d" == this.context)
              for (var a in n.options) o[a] = n.options[a];
            else o.clear(o.COLOR_BUFFER_BIT);
            if (!(n.options.minZoom && s.getZoom() < n.options.minZoom || n.options.maxZoom && s.getZoom() > n.options.maxZoom)) {
              ...
              var s = this.map,
                l = s.getProjection(),
                h = (r = Math.pow(2, s.zoom) * resolutionScale, l.fromLatLngToPoint(this.canvasLayer.getTopLeft())),
                u = {
                  transferCoordinate: function (t) {
                    var e = new google.maps.LatLng(t[1], t[0]),
                      n = l.fromLatLngToPoint(e),
                      i = {
                        x: (n.x - h.x) * r,
                        y: (n.y - h.y) * r
                      };
              ...
              var c = n.dataSet.get(u);
              this.processData(c);
              var p = new google.maps.LatLng(0, 0),
                f = l.fromLatLngToPoint(p),
                v = {
                  x: (f.x - h.x) * r,
                  y: (f.y - h.y) * r
                };
              "m" == n.options.unit && n.options.size ? n.options._size = n.options.size / zoomUnit : n.options._size = n.options.size, this.drawContext(o, new g(c), n.options, v), n.options.updateCallback && n.options.updateCallback(t)
            }
          }
        }
      }, {
    ...
    Mt = {
      ...
      getDataSet: function (t, e) {
        for (var n = this.CSVToArray(t, e || ","), i = [], o = n[0], a = 1; a < n.length - 1; a++) {
          for (var r = n[a], s = {}, l = 0; l < r.length; l++) {
            var h = r[l];
            "geometry" == o[l] && (h = JSON.parse(h)), s[o[l]] = h
          }
          i.push(s)
        }
        return new g(i)
  ...
  t.version = "2.0.20", t.canvasClear = e, t.canvasResolutionScale = function (t) {
  ...
  }, t.canvasDrawSimple = p, t.canvasDrawHeatmap = m, t.canvasDrawGrid = x, t.canvasDrawHoneycomb = _, t.webglDrawSimple = nt, t.webglDrawPoint = E, t.webglDrawLine = A, t.webglDrawPolygon = et, t.utilCityCenter = a, t.utilCurve = ot, t.utilForceEdgeBundling = function () {
    var t = {},
      e = [],
      n = [],
      i = [],
    ...
    function v(t) {
      for (var e = 0, n = 1; n < i[t].length; n++) e += d(i[t][n], i[t][n - 1]);
      return e
    }
    ...
    function m(t, e, o) {
      for (var a, r = {
          x: 0,
          y: 0
        }, s = n[t], l = 0; l < s.length; l++) {
        var h = {
          x: i[s[l]][e].x - i[t][e].x,
          y: i[s[l]][e].y - i[t][e].y
        };
        if (Math.abs(h.x) > c || Math.abs(h.y) > c) {
          var u = 1 / Math.pow((a = {
            source: i[s[l]][e],
            target: i[t][e]
    ...
    function x(t, n, a) {
      for (var r, s, l, h, u, g, c, p, v = o / (f(e[t]) * (n + 1)), d = [{
          x: 0,
          y: 0
        }], y = 1; y < n + 1; y++) {
        var x = {
          ...
          _ = (s = y, l = v, c = void 0, p = void 0, h = i[r = t][s - 1], u = i[r][s + 1], g = i[r][s], c = h.x - g.x + u.x - g.x, p = h.y - g.y + u.y - g.y, {
            x: c *= l,
            y: p *= l
          }),
          w = m(t, y);
        x.x = a * (_.x + w.x), x.y = a * (_.y + w.y), d.push(x)
      }
      return d.push({
        x: 0,
        y: 0
    ...
    function _(n) {
      for (var o = 0; o < e.length; o++)
        if (1 == n) i[o].push(t[e[o].source]), i[o].push((p = e[o], {
          ...
          var a = v(o) / (n + 1),
            ...
            s = [];
          s.push(t[e[o].source]);
          for (var l = 1; l < i[o].length; l++) {
            for (var h = d(i[o][l], i[o][l - 1]); h > r;) {
              var u = r / h,
                g = i[o][l - 1].x,
                c = i[o][l - 1].y;
              g += u * (i[o][l].x - i[o][l - 1].x), c += u * (i[o][l].y - i[o][l - 1].y), s.push({
                x: g,
                y: c
              }), h -= r, r = a
            }
    ...
    function w(e, n) {
      ...
      return Math.max(0, 1 - 2 * d(r, a) / d(i, o))
    }

    function b(e, n) {
      var i, o, a, r, s, l, h, u, g, c, v, y;
      return g = e, c = n, Math.abs((v = p(g), y = p(c), (v.x * y.x + v.y * y.y) / (f(g) * f(c)))) * (h = n, 2 / ((u = (f(l = e) + f(h)) / 2) / Math.min(f(l), f(h)) + Math.max(f(l), f(h)) / u)) * (r = n, (s = (f(a = e) + f(r)) / 2) / (s + d({
      ...
      function () {
        ...
        function () {
          for (var t = 0; t < e.length - 1; t++)
            for (var i = t + 1; i < e.length; i++) t != i && (o = e[t], a = e[i], b(o, a) >= g && (n[t].push(i), n[i].push(t)));
          var o, a
        }();
      for (var p = 0; p < l; p++) {
        for (var f = 0; f < s; f++) {
          for (var v = [], d = 0; d < e.length; d++) v[d] = x(d, c, o);
          for (var y = 0; y < e.length; y++)
            for (var m = 0; m < c + 1; m++) i[y][m].x += v[y][m].x, i[y][m].y += v[y][m].y
        }
        o /= 2, s *= u, _(c *= 2)
      }
      return i
    };
    return S.nodes = function (e) {
      return 0 == arguments.length ? t : (t = e, S)
    }, S.edges = function (n) {
    ...
    }, S.bundling_stiffness = function (t) {
      return 0 == arguments.length ? o : (o = t, S)
    }, S.step_size = function (t) {
      return 0 == arguments.length ? a : (a = t, S)
    }, S.cycles = function (t) {
      return 0 == arguments.length ? l : (l = t, S)
    }, S.iterations = function (t) {
      return 0 == arguments.length ? h : (h = t, S)
    }, S.iterations_rate = function (t) {
      return 0 == arguments.length ? u : (u = t, S)
    }, S.subdivision_points_seed = function (t) {
      return 0 == arguments.length ? P : (P = t, S)
    }, S.subdivision_rate = function (t) {
      return 0 == arguments.length ? s : (s = t, S)
    }, S.compatbility_threshold = function (t) {
      return 0 == arguments.length ? compatbility_threshold : (g = t, S)
    }, S
  }, t.utilDataRangeIntensity = v, t.utilDataRangeCategory = at, t.utilDataRangeChoropleth = rt, t.Map = st, t.baiduMapCanvasLayer = lt, t.baiduMapAnimationLayer = mt, t.baiduMapLayer = xt, t.googleMapCanvasLayer = _t, t.googleMapLayer = bt, t.DataSet = g, t.geojson = St, t.csv = Mt, Object.defineProperty(t, "__esModule", {
    value: !0
  })
});
