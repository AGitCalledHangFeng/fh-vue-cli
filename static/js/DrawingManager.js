...
(function () {
  ...
  DrawingTool.prototype._generalHtml = function (map) {
    ...
    //添加删除覆盖物的按钮(by-fenghang)
    html.push('<a id="removeToolOverlay" class="BMapLib_box removeToolOverlay BMapLib_last" href="javascript:void(0)" title="移除当前绘制图形" onfocus="this.blur()"></a>')
    return html.join('');
  }
  ...
  DrawingTool.prototype._bind = function (panel) {
    ...
    baidu.on(this.panel, 'click', function (e) {
      ...
      if (target.getAttribute('drawingType')) {
