  ...
  return function (e) {
    ...
    var _ = function () {
      ...
      I = function () {
        ...
        if ("function" == typeof e && h.a.locale) return O || (O = !0, h.a.locale(h.a.config.lang, p()(P, h.a.locale(h.a.config.lang) || {}, {
          clone: !0
    ...
    var $t = St,
      Et = function () {
        ...
        return (this._self._c || e)("li", {
          ...
          class: {
            "is-disabled": this.disabled, "el-dropdown-menu__item--divided": this.divided
          },
          attrs: {
    ...
    on.prototype.mutations = {
      ...
      changeSortCondition: function (e, t) {
        ...
        if (s && r) {
          var o = e.data,
            a = s.querySelector("tbody").children,
            l = [].filter.call(a, function (e) {
